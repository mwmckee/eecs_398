...
public class SwitchAccountAccountsListAdapter extends BaseAdapter{
	...
	public SwitchAccountAccountsListAdapter(Activity activity){
	...
	public View getView(int index, View view, ViewGroup parent) {
		...
		if(view == null){
			button = (Button)activity.getLayoutInflater().inflate(R.layout.list_item_account_switch_account, null);
